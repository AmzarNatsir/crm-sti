        ...
        <div class="content">
            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3">
                <div class="flex-grow-1">
                    <h6 class="fw-bold mb-0 d-flex align-items-center"><a href="{{route('sales.index')}}" class=""><i
                                class="ti ti-chevron-left me-1 fs-14"></i>Sales</a></h6>
                </div>
            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="customer_id" required>
                                        ...
                                        @foreach($customers as $customer)
                                            ...
                                            @endphp
                                            <option value="{{$customer->id}}">{{$customerLabel}} ({{$customer->type}})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="invoice_no" value="INV-{{time()}}"
                                        required>
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group w-auto input-group-flat">
                                        <input type="text" class="form-control" name="invoice_date"
                                            ...
                                            data-provider="flatpickr" data-date-format="Y-m-d" data-alt-input="true"
                                    ...
                                    <table class="table invoice-table border" id="items-table">
                                        ...
                                        <tbody class="invoices-list">
                                            <tr class="invoices-list-item">
                                                ...
                                                <td>
                                                    <select class="form-select type-select" name="items[0][price_type]"
                                                        required>
                                                ...
                                                <td><input type="text" class="form-control price-input"
                                                        name="items[0][price]" required></td>
                                                <td><input type="number" class="form-control qty-input" name="items[0][qty]"
                                                        value="1" min="1" required></td>
                                                <td><input type="text" class="form-control subtotal-input" readonly
                                                        value="0"></td>
                                                <td><button type="button" class="btn remove-item btn-sm text-danger"><i
                                                            class="ti ti-trash"></i></button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <button type="button" class="btn btn-sm btn-primary mt-2" id="add-item"><i
                                            class="ti ti-plus me-1"></i>Add Item</button>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="border p-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm w-50" name="invoice_discount"
                                            id="invoice-discount" value="0">
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <h6 class="fs-14 fw-normal text-dark">Shipping Cost (Rp)</h6>
                                        <input type="text" class="form-control form-control-sm w-50" name="shipping_cost"
                                            id="shipping-cost" value="0">
                                    </div>
