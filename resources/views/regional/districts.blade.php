    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Regional Data - {{ $regency->name }}</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('regional.index') }}">Provinces</a></li>
                            <li class="breadcrumb-item">
                                <a href="{{ route('regional.regencies', $regency->province_id) }}">
                ...
                <div>
                    <form action="" method="GET">
                        <div class="input-icon input-icon-start position-relative">
                            ...
                            <input type="text" class="form-control" name="search" placeholder="Search Districts..." value="{{ request('search') }}">
                        </div>
                    </form>
                </div>
            </div>
                ...
                <table class="table table-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('regional.villages', $district->id) }}" class="btn btn-sm btn-outline-primary">
                                    View Villages
                                </a>
                            </td>
                        </tr>
