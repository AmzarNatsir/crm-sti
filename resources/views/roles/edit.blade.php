                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="form-check form-check-md d-inline-block">
                                            <input class="form-check-input perm-check-{{ Str::slug($module) }}" type="checkbox" name="permissions[]" value="{{ $permission->name }}" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }}>
                                        </div>
                                        @else
                                        -
                                        @endif
...
<script>
    $(document).ready(function() {
        ...
        $('.select-all-module').each(function() {
            const module = $(this).data('module');
            const total = $(`.perm-check-${module}`).length;
            const checked = $(`.perm-check-${module}:checked`).length;
