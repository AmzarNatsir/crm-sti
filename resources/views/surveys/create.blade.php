...
<div class="page-wrapper">
    <div class="content pb-0">
        <div class="mb-4">
            <h4 class="mb-1">Survey Telemarketing</h4>
                ...
                <div id="survey-wizard">
                    ...
                    <form id="survey-form" action="{{ route('surveys.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="step-content d-none" id="step-3">
                           <div class="row">
                                <div class="col-md-12 mb-3">
                                    <h5 class="text-primary mb-3">Penyelesaian Masalah</h5>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Dampak</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Estimasi potensi penurunan hasil</label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Riwayat tindakan</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Produk solusi yang digunakan</label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Akar dugaan</label>
                                                    <select name="akarDugaan" class="form-select trigger-other" data-target="#akarDugaan_Lainnya">
                                                        <option value="">Select Cause</option>
                                                        <option value="Nutrients">Nutrisi</option>
                                                        <option value="Pests">OPT</option>
                                                        <option value="Water">Air</option>
                                                        <option value="Weather">Cuaca</option>
                                                        <option value="Cultivation Techniques">Teknik budidaya</option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Kebutuhan dukungan</label>
                                                    <select name="kebutuhanDukungan" class="form-select">
                                                        <option value="">Select Support</option>
                                                        <option value="Konsultasi online">Konsultasi online</option>
                                                        <option value="Kunjungan agronomis">Kunjungan agronomis</option>
                                                        <option value="Eskalasi ke pabrik">Eskalasi ke pabrik</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Rencana tindakan & SLA</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Paket rekomendasi</label>
                                                    <input type="text" name="rencanaAksiDisepakati_PaketRekomendasi" class="form-control">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Siapa melakukan apa & kapan</label>
                                                    <input type="text" name="rencanaAksiDisepakati_Siapa" class="form-control">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Tanggal monitoring (SLA)</label>
                                                    <input type="date" name="slaPemantauan_Tanggal" class="form-control">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Jam monitoring (SLA)</label>
                        ...
                        <div class="step-content d-none" id="step-4">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <h5 class="text-primary mb-3">Statistik & Konteks Pertanian</h5>
                                </div>

                                <!-- Rainfall & Events -->
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Curah hujan & peristiwa cuaca</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Curah hujan 30 hari terakhir (persepsi)</label>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Peristiwa cuaca ekstrem</label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Harga & Hasil Panen</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Tren harga pupuk/benih/pestisida</label>
                                                    <input type="text" name="harga_TrenHargaPupukBenihPestisida" class="form-control" placeholder="e.g. Menurun, Stabil">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Harga jual hasil panen (Rp/kg) saat ini</label>
                                                    <input type="text" name="harga_HargaJualHasilPanen" class="form-control" placeholder="e.g. 10000">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Perubahan praktik budidaya</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Varietas baru</label>
                                                    <input type="text" name="perubahanPraktikBudidaya_VarietasBaru" class="form-control" placeholder="Jika ada">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Perubahan teknik olah lahan</label>
                                                    <input type="text" name="perubahanPraktikBudidaya_PerubahanTeknik" class="form-control" placeholder="Jika ada">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Penggunaan mesin/alat</label>
                                                    <input type="text" name="perubahanPraktikBudidaya_PenggunaanMesin" class="form-control" placeholder="Jika ada">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Sumber informasi Petani</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Tokoh lokal</label>
                                                    <input type="text" name="sumberInformasiPetani_TokohLokal" class="form-control" placeholder="Name tokoh lokal">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Penyuluh</label>
                                                    <input type="text" name="sumberInformasiPetani_Penyuluh" class="form-control" placeholder="Name penyuluh">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="step-content d-none" id="step-5">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <h5 class="text-primary mb-3">Penutup & Ringkasan</h5>
                                </div>

                                <!-- Summary -->
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Ringkasan kebutuhan & solusi yang ditawarkan</div>
                                        <div class="card-body">
                                            <textarea name="ringkasanKebutuhanSolusi" class="form-control" rows="3" placeholder="Ringkasan kebutuhan & solusi yang ditawarkan"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Komitmen/Janji tindak lanjut</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Apa yang dijanjikan?</label>
                                                    <input type="text" name="komitmenTindakLanjut_Apa" class="form-control" placeholder="Apa yang dijanjikan?">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Oleh siapa?</label>
                                                    <input type="text" name="komitmenTindakLanjut_OlehSiapa" class="form-control" placeholder="Oleh siapa?">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label">Kapan (Tanggal)?</label>
                                                    <input type="date" name="komitmenTindakLanjut_KapanTanggal" class="form-control">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label">Kapan (Jam)?</label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Jadwal follow-up berikutnya</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card">
                                        <div class="card-header bg-light fw-bold">Dokumentasi (Opsional)</div>
                                        <div class="card-body">
    ...
    $(document).ready(function() {
        ...
        function restoreStep2Data(data) {
            ...
            if (type === 'STI Customer' && data.pelangganSTI) {
                ...
                if(prospekData.kesiapanUjiCobaProdukSti === 'Not Ready') {
            ...
            if(type === 'STI Customer') {
                html += `
                    <div class="col-md-12 mb-3">
                        ...
                        <!-- Plant Development -->
                        <div class="card mb-3">
                            <div class="card-header bg-light fw-bold">Pertumbuhan Tanaman (Skala 0-10)</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                ...
                html += `
                    <div class="col-md-12 mb-3">
                        <h5 class="text-primary mb-3">Farmer Prospect Survey</h5>
