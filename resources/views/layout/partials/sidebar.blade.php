                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{url('dashboard')}}"
                                            class="{{ Request::is('dashboard', '/') ? 'active' : '' }}">Telemarketing</a>
                                    </li>
                                    <li><a href="{{url('customers-dashboard')}}"
                                            class="{{ Request::is('customers-dashboard') ? 'active' : '' }}">Customer</a>
                                    </li>
                                    <!-- <li><a href="{{url('prospects-dashboard')}}" class="{{ Request::is('prospects-dashboard') ? 'active' : '' }}">Prospects</a></li> -->
                                    <li><a href="{{url('products-dashboard')}}"
                                            class="{{ Request::is('products-dashboard') ? 'active' : '' }}">Products</a>
                                    </li>
                                    <li><a href="{{url('sales-dashboard')}}"
                                            class="{{ Request::is('sales-dashboard') ? 'active' : '' }}">Sales</a></li>
                                    <li><a href="{{url('employees-dashboard')}}"
                                            class="{{ Request::is('employees-dashboard') ? 'active' : '' }}">Employee
                                            Analysis</a></li>
                                    <li><a href="{{url('crm-dashboard')}}"
                                            class="{{ Request::is('crm-dashboard') ? 'active' : '' }}">CRM Analysis</a></li>
                                    <li><a href="{{url('customer-loyalty-dashboard')}}"
                                            class="{{ Request::is('customer-loyalty-dashboard') ? 'active' : '' }}">Customer
                                            Loyalty</a></li>
                                    <li><a href="{{url('customer-lifecycle')}}"
                                            class="{{ Request::is('customer-lifecycle') ? 'active' : '' }}">Customer
                                            Lifecycle</a></li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            @can("common_payment_method_view")
                                <li class=" {{ Request::is('common-payment-method*') ? 'active' : '' }}">
                                    <a href="{{url('common-payment-method')}}"><i class="ti ti-settings-cog"></i><span>Payment
                                            Method</span></a>
                                </li>
                            @endcan
                            @can("common_position_view")
                                <li class=" {{ Request::is('common-position*') ? 'active' : '' }}">
                                    <a href="{{url('common-position')}}"><i
                                            class="ti ti-settings-cog"></i><span>Position</span></a>
                                </li>
                            @endcan
                            <li class=" {{ Request::is('expedition*') ? 'active' : '' }}">
                                <a href="{{url('expedition')}}"><i
                                        class="ti ti-truck-delivery"></i><span>Expedition</span></a>
                            </li>
                        </ul>
                    </li>
                @endcanany
                        ...
                        <ul>
                            @can("ref_compaign_view")
                                <li class=" {{ Request::is('ref-compign*') ? 'active' : '' }}">
                                    <a href="{{url('ref-compign')}}"><i
                                            class="ti ti-settings-cog"></i><span>Campaigns</span></a>
                                </li>
                            @endcan
                            @can("ref_commodity_view")
                                <li class=" {{ Request::is('ref-commodity*') ? 'active' : '' }}">
                                    <a href="{{url('ref-commodity')}}"><i
                                            class="ti ti-settings-cog"></i><span>Commodity</span></a>
                                </li>
                            @endcan
                        ...
                        <ul>
                            ...
                            @can("telemarketing_admin")
                                <li class="{{ Request::is('admin-surveys/create') ? 'active' : '' }}">
                                    <a href="{{ url('admin-surveys/create') }}"><i class="ti ti-forms"></i><span>Admin
                                            Marketing</span></a>
                                </li>
                            @endcan
                        ...
                        <ul>
                            @can("prospects_view")
                                <li class="{{ Request::is('prospects') ? 'active' : '' }}" href="{{ url('prospects') }}">
                                    <a href="{{url('prospects')}}"><i
                                            class="ti ti-timeline-event-exclamation"></i><span>Prospects</span></a>
                                </li>
                            @endcan
                            @can("customers_view")
                                <li
                                    class="{{ Request::is('customers', 'customers-list', 'customers-details') ? 'active' : '' }}">
                                    <a href="{{url('customers')}}"><i
                                            class="ti ti-brand-campaignmonitor"></i><span>Customers</span></a>
                                </li>
                            @endcan
                            @can("products_view")
                            ...
                            @can("approval_center_view")
                                <li class="{{ Request::is('approvals*') ? 'active' : '' }}">
                                    <a href="{{ route('approvals.index') }}"><i class="ti ti-list-check"></i><span>Approval
                                            Center</span></a>
                                </li>
                            @endcan
                            @can("reminders_view")
                                <li
                                    class="{{ Request::is('reminders', 'reminders-list', 'reminder-details') ? 'active' : '' }}">
                                    <a href="{{url('reminders')}}"><i class="ti ti-file-star"></i><span>Reminder</span></a>
                                </li>
                            @endcan
                            @can("followups_view")
                                <li
                                    class="{{ Request::is('followups', 'followups-list', 'followup-details') ? 'active' : '' }}">
                                    <a href="{{url('followups')}}"><i class="ti ti-file-check"></i><span>Follow-Up</span></a>
                                </li>
                            @endcan
                            @can("activities_view")
                                <li
                                    class="{{ Request::is('activities', 'activity-calls', 'activity-mail', 'activity-meeting', 'activity-task') ? 'active' : '' }}">
                                    <a href="{{url('activities')}}"><i
                    ...
                    <li>
                        <ul>
                            <li class="{{ Request::is('param-wilayah*') ? 'active' : '' }}">
                                <a href="{{ route('param-wilayah.index') }}"><i
                                        class="ti ti-settings-cog"></i><span>Regional Parameter</span></a>
                            </li>
                            <li class="{{ Request::is('koef-medan*') ? 'active' : '' }}">
                                <a href="{{ route('koef-medan.index') }}"><i class="ti ti-settings-cog"></i><span>Medan
                                        Coefficient</span></a>
                            </li>
                            @can("delivery_schedule_view")
                                <li class="{{ Request::is('delivery-schedule*') ? 'active' : '' }}">
                                    <a href="{{ route('delivery-schedule.index') }}"><i class="ti ti-truck"></i><span>Delivery
                                            Schedule</span></a>
                                </li>
                            @endcan
                        </ul>
                    ...
                    <li>
                        <ul>
                            <li class="{{ Request::is('users') ? 'active' : '' }}"><a href="{{url('users')}}"><i
                                        class="ti ti-users"></i><span>Manage Users</span></a></li>
                            <li class="{{ Request::is('roles') ? 'active' : '' }}"><a href="{{url('roles')}}"><i
                                        class="ti ti-user-shield"></i><span>Roles</span></a></li>
                            <li class="{{ Request::is('permission-subjects') ? 'active' : '' }}"><a
                                    href="{{url('permission-subjects')}}"><i class="ti ti-folder"></i><span>Permission
                                        Subjects</span></a></li>
                            <li class="{{ Request::is('permissions') ? 'active' : '' }}"><a href="{{url('permissions')}}"><i
                                        class="ti ti-shield"></i><span>Permissions</span></a></li>
                        </ul>
                    </li>
                @endcanany
            </ul>
